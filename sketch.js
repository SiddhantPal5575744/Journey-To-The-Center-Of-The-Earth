...
coineffect=loadSound("coineffect.wav");
...
c1=createSprite(50,displayHeight/2);
c1.addImage(coinImg);
c1.visible=false;
c1.scale=0.6;

c2=createSprite(100,displayHeight/2);
c2.addImage(coinImg);
c2.visible=false;
c2.scale=0.6;

c3=createSprite(200,displayHeight/2);
c3.addImage(coinImg);
c3.visible=false;
c3.scale=0.6;

c4=createSprite(300,displayHeight/2);
c4.addImage(coinImg);
c4.visible=false;
c4.scale=0.6;

c5=createSprite(400,displayHeight/2);
c5.addImage(coinImg);
c5.visible=false;
c5.scale=0.6;


c6=createSprite(500,displayHeight/2);
c6.addImage(coinImg);
c6.visible=false;
c6.scale=0.6;

c7=createSprite(600,displayHeight/2);
c7.addImage(coinImg);
c7.visible=false;
c7.scale=0.6;

c8=createSprite(700,displayHeight/2);
c8.addImage(coinImg);
c8.visible=false;
c8.scale=0.6;

c9=createSprite(800,displayHeight/2);
c9.addImage(coinImg);
c9.visible=false;
c9.scale=0.6;

c10=createSprite(900,displayHeight/2);
c10.addImage(coinImg);
c10.visible=false;
c10.scale=0.6;

c11=createSprite(50,displayHeight/2+100);
c11.addImage(coinImg);
c11.visible=false;
c11.scale=0.6;

c12=createSprite(100,displayHeight/2+100);
c12.addImage(coinImg);
c12.visible=false;
c12.scale=0.6;

c13=createSprite(200,displayHeight/2+100);
c13.addImage(coinImg);
c13.visible=false;
c13.scale=0.6;

c14=createSprite(300,displayHeight/2+100);
c14.addImage(coinImg);
c14.visible=false;
c14.scale=0.6;

c15=createSprite(400,displayHeight/2+100);
c15.addImage(coinImg);
c15.visible=false;
c15.scale=0.6;


c16=createSprite(500,displayHeight/2+100);
c16.addImage(coinImg);
c16.visible=false;
c16.scale=0.6;

c17=createSprite(600,displayHeight/2+100);
c17.addImage(coinImg);
c17.visible=false;
c17.scale=0.6;

c18=createSprite(700,displayHeight/2+100);
c18.addImage(coinImg);
c18.visible=false;
c18.scale=0.6;

c19=createSprite(800,displayHeight/2+100);
c19.addImage(coinImg);
c19.visible=false;
c19.scale=0.6;

c20=createSprite(900,displayHeight/2+100);
...
if(gamestate==="insidemine"){
  ...
  mine.visible=false;
  setTimeout(landslidechanger,4000)
  ...
  if(gamestate==="landslide"){
   ...
   rbt="touched";
    ...
    if(keyDown("LEFT_ARROW")&&lbr===1){
      ...
      setTimeout(intoTheHole,30000);

     if((coingroup).isTouching(player)){
       coingroup.destroyEach();
       coineffect.play();
       setTimeout(coineffectstop,1000);
...
robot.depth=hole.depth+1;
   ...
   if(keyDown('UP_ARROW')&&player.y>554){
    player.velocityY=-8;
...
alien.depth=robot.depth+1;
  ...
  player.y=displayHeight/2+270;
  player.x=displayWidth/2;

  
  robot.y=displayHeight/2+270;
  robot.x=displayWidth/2-200;
...
//  cave.visible=true;
  ...
  if(coinnumber>0&&coinnumber>=1){
    c1.visible=true;
  }

  if(coinnumber>1&&coinnumber>=2){
    c1.visible=true;
    c2.visible=true;
  }

  if(coinnumber>2&&coinnumber<=3){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
  }

  if(coinnumber>3&&coinnumber<=4){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>10&&coinnumber<=11){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>11&&coinnumber>=12){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>12&&coinnumber>=13){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>13&&coinnumber<=14){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>14&&coinnumber<=15){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>15&&coinnumber<=16){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>16&&coinnumber<=17){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>17&&coinnumber<=18){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>18&&coinnumber<=19){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
  ...
  if(coinnumber>19&&coinnumber<=20){
    c1.visible=true;
    c2.visible=true;
    c3.visible=true;
    c4.visible=true;
...
function rocklandcoin(){
  if(frameCount%100===0){
    coin=createSprite(displayWidth,displayHeight/2+50,10,10)
    coin.addImage(coinImg);
    coin.velocityX=-12;
    coin.scale=0.4
    coin.lifeTime=displayHeight/4;
    coin.depth=cave.depth+1;
    coingroup.add(coin);
  }
}
