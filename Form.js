class Form {
    ...
    //  this.title.position(displayWidth/2 -200, 50);
     ...
     this.danger1.html("Robot: Oh no this is a landslide save yourself from the rocks or you will be killed!,use the arrow keys to move. Collect the coins to go to the next stage")
     ...
     this.up.html("Robot:Finally we have reached the volcanic duct from where we can use our jetpack and fly away");
     this.up.position(displayWidth/2 - 300, displayHeight/4);
     this.up.style('color','#ffffff');
     this.up.hide();

     this.score.html("You colloected these many coins");
  this.score.position(displayWidth/2 -100, displayHeight/2-100);
